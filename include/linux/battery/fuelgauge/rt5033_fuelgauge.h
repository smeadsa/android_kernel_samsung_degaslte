...
struct battery_data_t{
	...
	gain_table_prop *param3_suspend;
	gain_table_prop *param4_suspend;
	...
	int param3_size;
	int param4_size;
	int param3_size_suspend;
	int param4_size_suspend;
	int offset1_size;
	int offset2_size;
	int offset3_size;
	int offset4_size;
...
struct sec_fg_info {
	...
	int32_t irq_ctrl;
	uint32_t entry_suspend_flag : 1; /* 0 : exit suspend mode, 1: entry suspend mode */
};
