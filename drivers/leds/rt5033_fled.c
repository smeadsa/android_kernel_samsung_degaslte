...
const static rt5033_fled_platform_data_t rt5033_default_fled_pdata = {
	...
	.fled_strobe_current = RT5033_STROBE_CURRENT(475), /* 1.2A -> 950mA */
	.fled_strobe_timeout = RT5033_STROBE_TIMEOUT(800), /* 544ms -> 800ms */
	.fled_torch_current = RT5033_TORCH_CURRENT(100), /* 76mA -> 200mA */
...
static __devinit int rt5033_fled_probe(struct platform_device *pdev)
{
	...
	if (ret < 0) {
		RTERR("failed to register pdevice\n");
